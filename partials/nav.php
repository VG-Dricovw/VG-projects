          ...
          -->
            ...
            <class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <!-- Profile dropdown -->
                 ...
                 if (true) {
                 ?>
              <button class="bg-gray-500 text-white rounded-md p-2"><a href="/register.php">register</a></button>
              <?php }
              else { ?>
              <button class="bg-gray-500 text-white rounded-md p-2"><a href="/login.php">login</a> </button>
